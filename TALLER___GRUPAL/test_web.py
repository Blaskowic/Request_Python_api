...
>>> # Ejecuta la prueba web (abre navegador)  # doctest: +SKIP
...
def probar_web() -> None:
    ...
    Flujo principal:
      1. Abrir Chrome mediante `webdriver-manager`.
      2. Cargar la página local y rellenar el formulario de importación.
      3. Pulsar el botón de confirmación y esperar para generar evidencia.
    ...
    """
    print("\n" + "="*40)
    print("🌐 [MÓDULO 2] TEST DE WEB (SELENIUM)")
    print("="*40)
    ...
    try:
        ...
        # 2. Interacción
        print("✍️  Llenando formulario de importación...")
